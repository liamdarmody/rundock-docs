...
<Frame caption="Talk to one agent and the team forms around the task: the orchestrator takes your request, hands it to the specialist who owns it, and the specialist's reply streams in. Hand-offs are visible in the panel.">
  <img src="/images/conversation-handoff.gif" alt="Rundock conversation: the user asks the orchestrator to shorten a landing hook, the orchestrator hands off to a Content Lead, and the Content Lead's reply streams in line by line." />
</Frame>
...
The conversation above shows a hand-off in action: you ask the orchestrator, it routes the task to the specialist who owns it, and the reply streams in as they work. You see who asked who, what was passed, and what came back, so when the work lands you know exactly which agent did what.
