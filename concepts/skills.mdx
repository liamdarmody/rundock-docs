...
<Frame caption="The skills panel shows what each skill is and which agents own it. The Used By row makes assignment visible without opening any agent file.">
  <img src="/images/skills-detail.png" alt="Rundock skills sidebar with the Slide Design skill open, showing the description and the Used By panel listing Des as the assigned agent." />
</Frame>
