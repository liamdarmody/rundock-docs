...
<Frame caption="The workspace inside Rundock. Same folder you see in Finder. Same files you can edit in any text editor.">
  <img src="/images/files.png" alt="Rundock file view: a workspace file tree on the left with folders and markdown files, and a note open on the right showing its properties panel and rendered content." />
</Frame>
...
<Frame caption="Delegation is visible. The orchestrator hands work to a specialist; you see who asked who, what was passed, what came back.">
  <img src="/images/conversation-handoff.gif" alt="Rundock conversation: the user asks the orchestrator to shorten a landing hook, the orchestrator hands off to a Content Lead, and the Content Lead's reply streams in." />
</Frame>
